...
def OptionGroupFactory(item=None, category=None, name='Size', required=False, min_choices=0, max_choices=None, shared_items=None):
    if category is None:
...
def OptionFactory(group=None, name='Option', price_modifier=Decimal('0.00'), is_available=True, items=None):
