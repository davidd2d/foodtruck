      ...
      combos: [
        ...
        },
        {
          ...
          combo_items: [
            {
              id: 903,
              display_name: 'Sélection fixe',
              item_id: 10,
              fixed_item_ids: [10, 20],
              fixed_items: [
                { id: 10, name: 'Sauce Pesto Roquette', base_price: '7.90', is_available: true },
                { id: 20, name: 'Tiramisu', base_price: '4.00', is_available: true },
              ],
